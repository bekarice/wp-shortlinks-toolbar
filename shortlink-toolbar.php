...
function shortlink_toolbar_menu() {
	...
	if ( is_singular() && !is_preview() ) {
		...
		$wp_admin_bar->add_node( array( 'id' => 'shortlink', 'title' => __( 'Shortlinks', 'shortlink-toolbar' ), 'href' => '#', 'meta' => array( 'onclick' => 'javascript:prompt("Short Link:", "' . $short . '");' ) ) );
		$wp_admin_bar->add_node( array( 'parent' => 'shortlink', 'id' => 'shortlink_shortened-link', 'title' => __( 'Get Shortlink', 'shortlink-toolbar' ), 'href' => '#', 'meta' => array( 'onclick' => 'javascript:prompt("Short Link:", "' . $short . '");' ) ) );
		$wp_admin_bar->add_node( array( 'parent' => 'shortlink', 'id' => 'shortlink_twitterlink', 'title' => __( 'Share on Twitter', 'shortlink-toolbar' ), 'href' => $twitter_link, 'meta' => array( 'target' => '_blank' ) ) );
		$wp_admin_bar->add_node( array( 'parent' => 'shortlink', 'id' => 'shortlink_bufferlink', 'title' => __( 'Share via Buffer', 'shortlink-toolbar' ), 'href' => $buffer_link,  'meta' => array( 'target' => '_blank' ) ) );
	}
}
